...
so you are encouraged to use [godoc](https://godoc.org/github.com/SearchPilot/utls#UConn).
...
It LGTM, but please open up Wireshark and check. If you see something — [say something](https://github.com/SearchPilot/utls/issues).
...
There sure are. If you found one that approaches practicality at line speed — [please tell us](https://github.com/SearchPilot/utls/issues).
...
# Client Hello IDs
See full list of `clientHelloID` values [here](https://godoc.org/github.com/SearchPilot/utls#ClientHelloID).  
