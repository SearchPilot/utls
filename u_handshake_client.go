...
import (
	...
	"github.com/SearchPilot/utls/internal/fips140tls"
	"github.com/SearchPilot/utls/internal/hpke"
	"github.com/SearchPilot/utls/internal/tls13"
...
func (c *UConn) echTranscriptMsg(outer *clientHelloMsg, echCtx *echClientContext) (err error) {
	...
	// See https://github.com/SearchPilot/utls/blob/e430876b1d82fdf582efc57f3992d448e7ab3d8a/ech.go#L276-L283
